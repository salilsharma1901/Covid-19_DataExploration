...
--Using CTE to perform some calculations
...
select * , (RollingPeopleVaccinated/population)*100 as PercentageOfRolllingPeopleVaccinated
from popvsVac



-- Using Temp Table to perform some calculations
...
--Creating view to store data which can be used for visualization
